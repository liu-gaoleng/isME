  ...
  items: [
    {
      type: 'video',
      topic: 'AI',
      title: '大模型的底层原理：神经网络、深度学习与反向传播',
      source: '漫士沉思录 · YouTube',
      url: 'https://www.youtube.com/watch?v=LF9sd-2jCoY&t=5024s',
      note: '近两小时讲透大模型底层——神经系统、深度学习、反向传播，知识硬核却讲得通俗。还顺手明白了：让 AI 精确说一句 20 个字的话，竟是件很难的事，你猜为什么？',
    },
    {
      type: 'tweet',
      topic: 'Tech',
      title: '可见的未来',
      source: '@SpermCapital · X',
      url: 'https://x.com/SpermCapital/status/2061372656306561206',
      note: '黄仁勋的全生态全方位布局真给人畅想——从 CPU、GPU 到模型、操作系统、自动驾驶，再到人形机器人，未来真的无法想象。',
    },
  ],
};
