...
export const notes: Note[] = [
  // ============ 碎碎念 ============
  {
    id: '2026-09-04-study-1',
    type: 'musing',
    date: '2026.09.04',
    category: '学习',
    title: '学习（一）',
    body: [
      '经过对于manus产品的初次尝试、分析以及问题的回答，学到了1.一个产品一经问世，附带的演示视频更多的是通过带来情绪价值、热点、新的形式等来实现的传播普及，但真正做到后续用户留存率高一定是要做到很好的解决用户的需求，演示是\'精选剧本\'，产品是\'开放世界\'。2.分析当前产品和竞品的差别可以通过用户使用产品完成需求的形式以及最终交付任务时所需要承担的责任来看，用户的需求->需求的完成->完成后需承担的责任。3.适合作为首批付费用户一定是产品在高价值、中高频、低信用的场景的用户4.分析留存要有数据支撑，但决策不能只参考数据。',
    ],
  },
  {
    id: '2026-08-17-lover',
